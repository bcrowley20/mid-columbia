...
Status: draft v11 — **Phases 0–5 complete**, plus a Render deployment (§16, done outside the phase sequence); agreed direction for Phase 6, later phases sketched and open to revision as we build.
